...
#SBATCH --job-name=assignment3_p2
#SBATCH --output=assignment3_problem2.out
#SBATCH --error=assignment3_problem2.err
...
SCRIPT_PATH="${SCRIPT_DIR}/assignment3_problem2.py"
